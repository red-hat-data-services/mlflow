"""Frozen copy of the RHOAI 3.3 workspace migration (1b5f0d9ad7c1).

This is a verbatim copy of the 3.3 version of
``mlflow/store/db_migrations/versions/1b5f0d9ad7c1_add_workspace_columns_and_catalog.py``.
It is used as a test fixture by ``test_migration_gap.py`` to faithfully reproduce the
database state of a real RHOAI 3.3 installation (including PK/FK restructuring) without
hand-maintaining raw SQL that could drift from the original.

This file is intentionally frozen and should NOT be updated.
"""
